...
exports.listTour = exports.index = void 0;
...
exports.index = index;
// [POST] /cart/list-json
var listTour = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var tours, cartDetail, total, _i, tours_1, tour, infoTour;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tours = req.body;
                ...
                _a.label = 1;
            case 1:
                if (!(_i < tours_1.length)) return [3 /*break*/, 4];
                tour = tours_1[_i];
